...
df=asia; dag=asia.dag; node.idx=7; pa.names = c("A"); pa.val = c('yes');which.val=2
seq.pa.ch.monitor(df=asia, dag=asia.dag, node.idx=7, pa.names = "A", pa.val = 'yes',which.val=2)
